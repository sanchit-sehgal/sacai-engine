...
int main(int argc, const char** argv) {
  ...
  EscCodes::Init();
  LOGFILE << "Lc0 started.";
  CERR << EscCodes::Bold() << EscCodes::Blue() << "";
  CERR << " ============================================";
  CERR << "|                                            |";
  CERR << "|                   " << EscCodes::Green() << "SACAI" << EscCodes::Blue()<<"                    |";
  CERR << "|               " << EscCodes::Green() <<"Sanchit Sehgal"<<EscCodes::Blue()<<"               |";
  CERR << "|             "<<EscCodes::Green()<<"Apache 2.0 License"<<EscCodes::Blue()<<"             |";
  CERR << "|                                            |";
  CERR << " ============================================"; 
  CERR << EscCodes::Reset();
  try {
